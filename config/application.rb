...
module S3FileManager
  class Application < Rails::Application
    ...
    #Rails.application.config.secret_token = '851939c37d94574e284ded8437d4ea3447dae24cc5bda61d8eaf2731d49273bc4c620'
    # Configure sensitive parameters which will be filtered from the log file.
    config.autoload_once_paths << "#{config.root}/app/config"
    require "#{config.root}/config/downcase_route_middleware.rb"
